export class UIHandler{
    ...
    static UIVisible(placeable){
        if(!game.user.isGM || !CONFIG.Levels.UI?.rangeEnabled || CONFIG.Levels.currentToken || (!placeable?.document?.flags.levels && !placeable?.document?.flags["wall-height"])) return;
