...
Hooks.on("init", () => {
    ...
    libWrapper.register(CONFIG.Levels.MODULE_ID, "MeasuredTemplate.prototype.draw", _levelsTemplatedraw, "WRAPPER");
...
Hooks.on("renderTileConfig", (app, html, data) => {
  ...
  <label for="rangeTop">${game.i18n.localize("levels.tileconfig.rangeTop.name")}<span class="units">(${game.i18n.localize("levels.tileconfig.range.unit")})</span></label>
...
<div class="form-group">
<label for="rangeBottom">${game.i18n.localize("levels.tileconfig.rangeBottom.name")}<span class="units">(${game.i18n.localize("levels.tileconfig.range.unit")})</span></label>
<div class="form-fields">
...
<div class="form-group">
            <label>${game.i18n.localize("levels.tileconfig.showIfAbove.name")}</label>
            <div class="form-fields">
        ...
        <div class="form-group">
<label for="showAboveRange">${game.i18n.localize("levels.tileconfig.showAboveRange.name")}<span class="units">(${game.i18n.localize("levels.tileconfig.range.unit")})</span></label>
<div class="form-fields">
    <input type="text" name="flags.${CONFIG.Levels.MODULE_ID}.showAboveRange" data-dtype="Number" value="${showAboveRange}" step="1">
        ...
        <div class="form-group">
            <label>${game.i18n.localize("levels.tileconfig.isBasement.name")}</label>
            <div class="form-fields">
        ...
        <div class="form-group">
        <label>${game.i18n.localize("levels.tileconfig.noFogHide.name")}</label>
        <div class="form-fields">
...
`;
    const overh = html.find('p[class="hint"]').eq(html.find('p[class="hint"]').length - 1);
    const formGroup = overh.closest(".form-group");
    formGroup.after(newHtml);
    app.setPosition({ height: "auto" });
});
...
<div class="form-group">
<label for="rangeTop">${game.i18n.localize("levels.drawingconfig.ht.name")}<span class="units">(${game.i18n.localize("levels.tileconfig.range.unit")})</span></label>
<div class="form-fields">
    <input type="text" name="flags.${CONFIG.Levels.MODULE_ID}.rangeTop"  data-dtype="Number" value="${heightRangeTop}" step="1">
</div>
</div>
...
<div class="form-group">
<label for="rangeBottom">${game.i18n.localize("levels.drawingconfig.hb.name")}<span class="units">(${game.i18n.localize("levels.tileconfig.range.unit")})</span></label>
<div class="form-fields">
  <input type="text" name="flags.${CONFIG.Levels.MODULE_ID}.rangeBottom"  data-dtype="Number" value="${heightRangeBottom}" step="1">
</div>
</div>
...
Hooks.on("renderMeasuredTemplateConfig", (app, html, data) => {
    ...
    let newHtml = `
<div class="form-group">
<label for="elevation">${game.i18n.localize("levels.template.elevation.name")}<span class="units">(${game.i18n.localize("levels.tileconfig.range.unit")})</span></label>
<div class="form-fields">
